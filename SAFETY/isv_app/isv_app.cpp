...
#define GET_VERIFICATION_ARRAY_INDEX() (verify_index-1)
	...
	if(atoi(argv[1]) == 0)
	{
		...
		ld(enclave_id, ldValues, result, strlen(argv[2])+strlen(argv[3])+strlen(argv[4])+strlen(argv[5])+4, 2);
	    cout<<result<<endl;
	}
	else if(atoi(argv[1]) == 1)
	{
		...
		hwe(enclave_id, hweValues, hweResult, strlen(argv[2])+strlen(argv[3])+strlen(argv[4])+3, 2);
	    cout<<hweResult<<endl;
	...
	else if((atoi(argv[1]) == 2) || (atoi(argv[1]) == 3))
	{
		...
		if(atoi(argv[1]) == 2)
		{
			...
			catt(enclave_id, cattValues, cattResult, strlen(argv[2])+strlen(argv[3])+strlen(argv[4])+strlen(argv[5])+strlen(argv[6])+strlen(argv[7])+6, 2);
		...
		else
		{
			...
			fet(enclave_id, cattValues, fetResult,  strlen(argv[2])+strlen(argv[3])+strlen(argv[4])+strlen(argv[5])+strlen(argv[6])+strlen(argv[7])+6, 2);
	        cout<<fetResult<<endl;
		}
	}
	else
